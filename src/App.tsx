...
const categories: Array<{
  ...
  },
  {
    ...
    question: "Does the sound of the object falling happen during the train sound?",
    answer: "Based on the timing, the time span of the train sound fully contains the full duration of the sound of the object falling.",
    visual: "temporal",
    group: "temporal",
    index: "03",
  },
...
function TaskDiagram({ kind, title }: { kind: TaskVisual; title: string }) {
  ...
  if (kind === "temporal") {
    return (
      <svg {...commonProps}>
        <title>Sound of an object falling contained within the train sound</title>
        <text className="diagram-label" x="8" y="38">Train sound</text>
        <text className="diagram-label" x="8" y="83">Falling sound</text>
  ...
  return (
    <div className="site-shell">
      ...
      <header className="site-header">
        <a className="brand" href="#top" aria-label="RMS-AQA home" onClick={() => setMenuOpen(false)}>
          <RmsaqaMark />
          <span className="brand-copy">
            <strong>RMS-AQA</strong>
      ...
      <main id="main-content">
        <section className="hero" id="top">
          ...
          <a className="scroll-cue" href="#participation" aria-label="Scroll to call for participation">
            <span>Discover RMS-AQA</span><ArrowDown size={16} />
          </a>
        </section>
        ...
        <section className="participation section section--raised" id="participation" aria-labelledby="participation-title">
          <div className="container">
            ...
            <div className="participation__copy">
              <p>
                The Real-world Multi-hop Spatial Audio Question Answering (RMS-AQA) challenge is
                ...
                are appropriate under safety constraints. RMS-AQA addresses this gap by extending
              ...
              <p>
                ...
                context-aware action, RMS-AQA provides common ground
        ...
        <section className="overview section" id="overview">
          <div className="container">
            ...
            <div className="overview-narrative">
              <p>
                RMS-AQA is a unified two-stage challenge for real-world multi-hop spatial audio
              ...
              <p>
                By connecting perception, reasoning, and risk‑aware decision making, RMS-AQA provides
        ...
        <section className="dataset section section--raised" id="dataset">
          <div className="container">
            ...
            <div className="dataset-details">
              <section className="dataset-subsection" aria-labelledby="training-validation-title">
                <h3 id="training-validation-title">Training and validation data</h3>
                ...
                <p className="dataset-note">
                  Simulated audio is generated with <strong>SpatialScaper</strong> by combining dry
                  sound events with measured spatial room impulse responses from the FOA-MEIR,
                  METU-SPARG, TAU-SRIR DB, and ARNI-SRIR databases. Dry events are selected from
                  AudioSet, FSD50K, and ESC-50.
                </p>
                <p className="dataset-note">
                  The simulated validation clips use room impulse responses measured in rooms that
                  do not overlap with any measured room used for the training-set RIRs. The real
                  validation clips were captured with a <strong>Zoom H3-VR</strong> recorder.
                </p>
                <p className="dataset-note">
                  Across all splits, every QA pair is a
                  <strong> multiple-choice question (MCQ)</strong> generated by
                  <strong> GPT-5.5</strong> from templates tailored to the different question types.
                  Every audio sample is provided in
                  <strong> First-Order Ambisonics (FOA)</strong> format at <strong>24 kHz</strong>.
                </p>
              </section>

              <section className="dataset-subsection" aria-labelledby="test-data-title">
                ...
                <p className="dataset-note">
                  ...
                  are consistent with those used for the real-recorded validation data. All test
                  recordings were collected in rooms that do not appear in either the training or
                  validation data.
                </p>
              </section>
            </div>
        ...
        <section className="resources section section--raised" id="resources">
          <div className="container">
            ...
            <div className="resource-sections">
              ...
              <section className="resource-subsection" aria-labelledby="guidelines-title">
                <h3 id="guidelines-title">Participation Guidelines</h3>
                <p>
                  External data and pretrained models are permitted but must be declared in the
                  system report. Manual annotation or modification of evaluation data, use of
                  hidden labels or metadata, and evaluation-set leakage are
        ...
        <section className="timeline section" id="timeline">
          <div className="container">
            <SectionHeading
              ...
              description="Key dates for registration, data release, evaluation, submissions, and the ICASSP 2027 challenge session."
            />
            <ol className="timeline-list" role="list">
              {timelineItems.map(({ date, dateTime, event }) => (
                <li className="timeline-row" key={`${date}-${event}`}>
        ...
        <section className="organizers section section--raised" id="organizers">
          <div className="container">
            <SectionHeading
              index="06 / Organizers"
      ...
      <footer className="site-footer">
        <div className="container site-footer__inner">
          <div className="footer-brand">
            <RmsaqaMark />
            <div><strong>RMS-AQA</strong><span>Real-world Multi-hop Spatial Audio Question Answering Challenge</span></div>
          </div>
