...
const categories: Array<{
  ...
  },
  {
    ...
    answer: "Yes. The sound of the object falling happens entirely during the train sound.",
    visual: "temporal",
    group: "temporal",
    index: "03",
  },
          ...
          <div className="container">
            ...
            <div className="dataset-details">
              <section className="dataset-subsection" aria-labelledby="training-validation-title">
                ...
                <p>
                  The training split contains <strong>170K audio clips</strong> and <strong>170K
                  two-layer QA pairs</strong>. The validation split contains <strong>6K audio
                  clips</strong> and <strong>6K two-layer QA pairs</strong>, evenly divided between
                  simulated and real-recorded data.
                </p>
                <p>
                  The <strong>3K simulated validation clips</strong> use room impulse responses
                  (RIRs) measured in rooms that do not overlap with any of the measured rooms used
                  for the training-set RIRs. The other <strong>3K validation clips</strong> are
                  real recordings captured with a <strong>Zoom H3-VR</strong> recorder.
                </p>
                <p>
              ...
              <section className="dataset-subsection" aria-labelledby="test-data-title">
                ...
                <p>
                  The test split contains <strong>3K real-recorded audio clips</strong> and
                  <strong> 3K two-layer QA pairs</strong>. Its QA data follow the same GPT-5.5
                  template-based generation process used for the training and validation splits,
                  and its audio uses the same <strong>FOA format</strong> and
                  <strong> 16 kHz sampling rate</strong>.
                </p>
                <p>
                  The test recordings were collected in rooms that are unseen in the validation
                  split, providing a separate evaluation of generalization to new real acoustic
                  environments.
                </p>
              </section>
            </div>
