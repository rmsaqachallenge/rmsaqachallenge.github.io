            ...
            <div className="dataset-details">
              <section className="dataset-subsection" aria-labelledby="training-validation-title">
                ...
                <ul className="dataset-facts">
                  ...
                  <li>
                    <strong>Validation:</strong> 6K audio clips and 6K two-layer QA pairs, evenly
                    divided between 3K simulated clips and 3K real-recorded clips.
                  </li>
                  <li>
                ...
                <p className="dataset-note">
                  All QA data are generated by <strong>GPT-5.5</strong> from templates tailored to
                  the different question types. Every audio sample is provided in
              ...
              <section className="dataset-subsection" aria-labelledby="test-data-title">
                ...
                <ul className="dataset-facts">
                  <li><strong>3K real-recorded audio clips.</strong></li>
                  <li><strong>3K two-layer QA pairs.</strong></li>
                  <li>
                ...
                <p className="dataset-note">
                  QA generation follows the same GPT-5.5 template-based process used for the
                  training and validation data. The audio also uses the same
                  <strong> FOA format</strong> and <strong>16 kHz sampling rate</strong>.
                </p>
              </section>
            </div>
