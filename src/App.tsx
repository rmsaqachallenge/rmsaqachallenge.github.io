            ...
            <div className="dataset-details">
              <section className="dataset-subsection" aria-labelledby="training-validation-title">
                ...
                <ul className="dataset-facts">
                  <li><strong>Training:</strong> 170K audio clips and 170K two-layer QA pairs.</li>
                  <li>
                    <strong>Validation:</strong> 5K audio clips and 5K two-layer QA pairs, comprising
                    3K simulated clips and 2K real-recorded clips.
                  </li>
                  <li>
                    <strong>Synthetic audio:</strong> Simulated clips are generated with
                    <strong> SpatialScaper</strong> by combining dry sound events with measured
                    spatial room impulse responses from the FOA-MEIR, METU-SPARG, TAU-SRIR DB,
                    and ARNI-SRIR databases.
                  </li>
                  <li>
                    <strong>Dry sound sources:</strong> Dry events are selected from AudioSet,
                    FSD50K, and ESC-50.
                  </li>
                  <li>
                    <strong>RIR separation:</strong> The simulated validation clips use room
                    impulse responses measured in rooms that do not overlap with any measured room
                    used for the training-set RIRs.
                  </li>
                  <li>
                    <strong>Real recordings:</strong> The real validation clips were captured with
                    a Zoom H3-VR recorder.
                  </li>
                </ul>
              </section>
              ...
              <section className="dataset-subsection" aria-labelledby="test-data-title">
                ...
                <ul className="dataset-facts">
                  <li><strong>2K real-recorded audio clips.</strong></li>
                  <li><strong>2K two-layer QA pairs.</strong></li>
                  <li>
                    <strong>Unseen rooms:</strong> The recordings were collected in rooms that do
                    not appear in the validation split.
                  </li>
                </ul>
                <p className="dataset-note">
                  ...
                  <strong> First-Order Ambisonics (FOA)</strong> format at <strong>16 kHz</strong>.
                </p>
              </section>
            </div>
            ...
            <div className="resource-sections">
              ...
              <section className="resource-subsection" aria-labelledby="guidelines-title">
                ...
                <p>
                  ...
                  system report. Manual annotation or modification of development or evaluation
                  data, use of hidden labels or metadata, and evaluation-set leakage are
          ...
          <div className="container">
            ...
            <div className="committee-block">
              ...
              <div className="committee-contact">
                <span className="mini-label">Committee contact</span>
